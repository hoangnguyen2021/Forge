...
Java_app_honguyen_forge_engine_RenderEngine_nativeVersion(JNIEnv *env, jclass) {
    LOGI("native layer initialized");
    return env->NewStringUTF("Forge Engine v0.2 | C++17 | OpenGL ES 3.1");
}

JNIEXPORT jlong JNICALL
Java_app_honguyen_forge_engine_RenderEngine_nativeCreate(JNIEnv *, jclass) {
    return reinterpret_cast<jlong>(new RenderEngine());
}

JNIEXPORT void JNICALL
Java_app_honguyen_forge_engine_RenderEngine_nativeDestroy(JNIEnv *, jclass, jlong handle) {
    delete asRenderEngine(handle);
}

JNIEXPORT void JNICALL
Java_app_honguyen_forge_engine_RenderEngine_nativeSurfaceCreated(JNIEnv *env, jclass,
...
JNIEXPORT void JNICALL
Java_app_honguyen_forge_engine_RenderEngine_nativeSetViewport(
...
JNIEXPORT void JNICALL
Java_app_honguyen_forge_engine_RenderEngine_nativeDrawFrame(JNIEnv *env, jclass,
